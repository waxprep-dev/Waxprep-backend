...
This flow is designed so the student NEVER has to leave WhatsApp.
They tap a link, pay in their phone browser, and come back.
"""
...
async def handle_subscription_flow(
    ...
    # Check for specific plan selections
...
async def initiate_payment(
    ...
    # Show generating message first
    await send_whatsapp_message(
        phone,
        f"⚙️ Generating your secure payment link, {name}...\n\n"
        f"One moment! ⏳"
    )
    ...
    try:
        ...
        msg = (
            ...
            f"_The link expires in 30 minutes. Generate a new one with_ *SUBSCRIBE* _if needed._"
        )
